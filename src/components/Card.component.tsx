...
function Card(this: any,  props: CardProps){
    ...
    const onDelete = () => {
        ...
        if(  localStorage.getItem('favoriteMovie') !== null ){
          ...
          userService.deleteFromFavorites(cookie.token, props.id)
    
          if(movieList.length > 0 ){
            movieList.filter( (e, i) =>{
              if(e.movieId === props.id){
